...
class Options():
    ...
    def add_reader_options(self):
        ...
        self.parser.add_argument('--query_maxlength', type=int, default=-1,
                        help='')
    ...
    def initialize_parser(self):
        ...
        self.parser.add_argument('--shuffle', type=str, default='None')
        self.parser.add_argument('--add_extra_token', action='store_true')
